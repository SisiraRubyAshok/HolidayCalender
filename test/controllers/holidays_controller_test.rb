...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference("Holiday.count") do
      post holidays_url, params: { holiday: { date_details: @holiday.date_details, holi_day: @holiday.holi_day } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { date_details: @holiday.date_details, holi_day: @holiday.holi_day } }
